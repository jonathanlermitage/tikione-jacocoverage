...
public class Config {
	...
	/**
	 * Set configuration value: path of custom JaCoCo jar to use instead of the bundled version.
	 *
	 * @param path configuration value.
	 */
	public static void setCustomJacocoJarPath(String path) {
		pref.put(Globals.PROP_CUSTOM_JACOCO_JAR_PATH, path);
	}
	...
	/**
	 * Set configuration value: use a custom JaCoCo jar instead of the bundled version.
	 *
	 * @param enbl configuration value.
	 */
	public static void setUseCustomJacocoJar(boolean enbl) {
		pref.putBoolean(Globals.PROP_USE_CUSTOM_JACOCO_JAR, enbl);
	}
