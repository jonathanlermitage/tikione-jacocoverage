...
## JaCoCoverage Java 7 and Java 8 Code Coverage for NetBeans

* The JaCoCoverage Plugin is a NetBeans 8.0 plugin that enhances the existing NetBeans functionality with new code coverage features.<br>
...
* Coverage collections are based on JaCoCo in order to **support Java 7 and Java 8 bytecode**. Take it as a modern alternative to the EMMA and
